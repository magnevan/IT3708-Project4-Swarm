...
%However, in a large and messy stagnated situation, with many bots surrounding 
%the target, there will always be some jostling between the bots. Because of
%this,
%the sensor values does not stay constant, and it is therefore hard to 
%correctly identify stagnation.
%Ideally, we define stagnation as the act of attempting to push a target, but
%not changing position, i.e. not having a speed.  
